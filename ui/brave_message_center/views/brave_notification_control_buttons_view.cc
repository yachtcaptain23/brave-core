...
void BraveNotificationControlButtonsView::ShowSettingsButton(bool show) {
...
void BraveNotificationControlButtonsView::ShowSnoozeButton(bool show) {
...
views::Button* BraveNotificationControlButtonsView::settings_button() const {
  return settings_button_.get();
}

views::Button* BraveNotificationControlButtonsView::snooze_button() const {
